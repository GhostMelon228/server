...
class UserRegistrationForm(UserCreationForm):
    ...
    def clean_username(self):
        ...
        if username and self._meta.model.objects.filter(username__iexact=username).exists():
            return self.add_error("Ник не должен быть пустым")
    ...
    def clean_first_name(self):
        ...
        if first_name == "":
            return self.add_error("Имени не может не быть")
    ...
    def clean_last_name(self):
        ...
        if last_name == "":
            return self.add_error("last_name", "Фамилия не может осутствовать")
    ...
    def clean_email(self):
        ...
        if email == '':
            return self.add_error("email", "Электронная почта не может быть пустой")
